...
/**
 * Composer which processes pdf files using ghostscript
 *
 ...
 * @package    CMP3
 */
class PdfGhostscript extends ComposerAbstract {
	...
	public function Process ($objResultArray)
	{
		...
		foreach($objResultArray as $objResult) {
			...
			$objGhostscript = new \Cmp3\Pdf\Ghostscript($objContent->File, $this->objConfig, $this->objLogger);

			$objFileResult = $objGhostscript->Render();
