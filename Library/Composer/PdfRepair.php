...
/**
 * Composer which repairs pdf files
 *
 * @author Rene Fritz (r.fritz@bitmotion.de)
 * @subpackage Composer
 * @package    CMP3
 */
class PdfRepair extends ComposerAbstract {
	...
	public function Process ($objResultArray)
	{
		...
		foreach($objResultArray as $objResult) {
			...
			if ($this->objLogger) $this->objLogger->Info(__CLASS__ . ' Processes result and repair pdf file');

			$objShrink = new \Cmp3\Pdf\Repair($objContent->File, $this->objConfig, $this->objLogger);
