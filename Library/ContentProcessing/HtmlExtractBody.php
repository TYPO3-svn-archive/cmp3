...
/**
 * Content processors which perform fetching content from html body
 *
 * 
 *
 ...
 * @package    CMP3
 */
class HtmlExtractBody extends ProcessorAbstract {


	/**
	 * fetching content from html body
	 *
	...
	public function Process (\Cmp3\Content\ContentInterface $objContent)
	{
		if ($content = $objContent->GetData()) {
			...
			$content = \Cmp3\String\HTML::GetBodyContent($content);
