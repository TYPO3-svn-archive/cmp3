...
/**
 * Content processors which changes img src to absolute
 *
 ...
 * @package    CMP3
 */
class HtmlMakeImgSrcAbsolute extends ProcessorAbstract {

	/**
	 * changes img src to absolute
	 *
	...
	public function Process (\Cmp3\Content\ContentInterface $objContent)
	{
		if ($content = $objContent->GetData()) {
			...
			//@todo fix urls in CSS: background-image:url(background2.gif);
