...
class Overlay_Test extends \TestCaseBase {
	...
	public function testRenderOneBottomTop()
	{
		...
		$objOverlay = new Overlay($objFileArray);
	...
	public function testRenderTwoBottomTop()
	{
		...
		$this->RenderMultiple($objFileArray, Overlay::FIRST_IS_BOTTOM, __METHOD__);
	}
	...
	public function testRenderOneTopBottom()
	{
		...
		$objFile1 = $objOverlay->Render(Overlay::FIRST_IS_TOP);
	...
	{
		$objFileArray = array($this->objFileArray[0], $this->objFileArray[1]);
		$this->RenderMultiple($objFileArray, Overlay::FIRST_IS_TOP, __METHOD__);
	}
