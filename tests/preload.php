...
# class_exists('\Next\DevTools');

// make dummy application
// $tsConfArray = array();
// $tsConfArray['devFunctions'] = false;
// $tsConfArray['modes'] = 'default.';
// $objAppDispatcher = new \Next\Dispatcher;
// $objAppDispatcher->prefixId = 'dummy';
// $objAppDispatcher->Path = $strExtensionPath;
// $objAppDispatcher->extKey = basename($strExtensionPath);
// #@todo how to set locale?
// $error = $objAppDispatcher->InitApplication($tsConfArray);
